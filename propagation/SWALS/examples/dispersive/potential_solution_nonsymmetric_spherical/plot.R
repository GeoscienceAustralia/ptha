...
plot(potential_y, potential_stage, t='l', xlab='Arc Degrees', ylab='Stage (m)',
    ylim=c(-1, 1)*2, lwd=5, lty='solid', main=paste0('Solution at final time = ', round(x[[1]]$time[ti],3) ))
if(using_staggered_schemes) points(potential_y, solend_lag[floor(length(xs)/2),], t='l', col='green', lwd=2)
