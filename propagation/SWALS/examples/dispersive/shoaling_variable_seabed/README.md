...
This problem was proposed by Kennedy et al. (2001) and is also used in Coulaud et al. (2025). 

A wave train is initialised with non-uniform stage and zero velocities over a
sloping seabed, and evolved for a set time period. The initial wave periods are
