...
The figure below compares modelled (black) and observed (red) free surface profiles for a relatively large amplitude wave. They agree quite well, and the dispersive model captures the shape of the wave prior to runup better than the non-dispersive model [../../nthmp/BP04](../../nthmp/BP04). That's because dispersion is significant for this relatively large solitary wave.
