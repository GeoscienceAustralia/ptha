...
* [propagation](propagation) contains the nested grid shallow water equations solver [SWALS](./propagation/SWALS/), used to model tsunamis in many of our studies. 
  * There are also many [documented test problems](propagation/SWALS/examples/), including from the well-known [National Tsunami Hazard Mitigation Program test suite](propagation/SWALS/examples/) and others [specific to dispersion](propagation/SWALS/dispersive/).
