...
As part of this study we compared the model with historical observations at Nuku'alofa tide-gauge. Here is one example, for a small tsunami following a local earhquake in 2006; other examples for tsunamis originating in Japan and Chile are available [at the bottom of this page](./swals/).
