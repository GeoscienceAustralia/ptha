...
model_names = paste0('ptha18_tonga_MSL0/ptha18_random_scenarios_', gsub('.tif', '', basename(raster_files), fixed=TRUE))
...
for(i in 1:number_of_qsub_files){
    output_qsub_filename = paste0('run_ptha18_random_tonga_msl0_', 1000 + i, '.sh')
