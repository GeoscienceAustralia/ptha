...
model_names = paste0('ptha18_tonga_MSL0_meshrefine4_msl80cm/ptha18_random_scenarios_', gsub('.tif', '', basename(raster_files), fixed=TRUE))

jobs_per_qsub_file = 10 # Run this many models in a single qsub file (or less), to stay within NCI walltime limits
...
for(i in 1:number_of_qsub_files){
    output_qsub_filename = paste0('run_ptha18_random_tonga_msl80cm_meshrefine4_', 1000 + i, '.sh')
