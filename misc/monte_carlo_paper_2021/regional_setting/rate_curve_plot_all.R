...
if(!file.exists(ptha18_rate_curve_session)) stop('You need download compute_rates_all_sources_session.RData in the ptha_access directory -- see the README in that folder for details')
