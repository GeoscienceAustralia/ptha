...
# Max depth/stage are set to NA if max_stage < elevation0 + WETDRY_THRESHOLD_STAGE_DEPTH
WETDRY_THRESHOLD_STAGE_DEPTH = 1e-03
...
single_multidomain_single_raster_creator<-function(i, multidomain_dir, raster_variable){
    ...
    if(raster_variable %in% c('max_stage', 'max_depth')){
        ...
        # Masked dry areas
        ms[ms < elev + WETDRY_THRESHOLD_STAGE_DEPTH] = NA
