...
reference_raster_tar_file = Sys.glob('../../swals/OUTPUTS/ptha18-kalbarri2onslow-hazard/random_*/*/raster_output_files.tar')[1]
...
source_zone_modelled_tsunami_scenario_basedirs = list(
    'outerrisesunda' = '../../swals/OUTPUTS/ptha18-kalbarri2onslow-hazard/random_outerrisesunda/',
    'sunda2'         = '../../swals/OUTPUTS/ptha18-kalbarri2onslow-hazard/random_sunda2/')
