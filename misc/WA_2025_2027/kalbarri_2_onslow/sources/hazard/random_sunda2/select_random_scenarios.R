...
mu_type = 'variable_mu'
reference_point_gaugeID = 1600.5
gaugeIDs_to_cross_check = c(
    1790.1, # Near Geraldton
    1989.2, # Offshore NW Cape
    1818.5 # Offshore Onslow    
    )
REPRODUCIBLE_SEED = 98765

# FIXME: Add variable_mu option
sz_full      = ptha18_source_rate_env$get_PTHA18_scenario_conditional_probability_and_rates_on_segment(source_zone, '', mu_type)
sz_java     = ptha18_source_rate_env$get_PTHA18_scenario_conditional_probability_and_rates_on_segment(source_zone, 'java', mu_type)
sz_sumatra  = ptha18_source_rate_env$get_PTHA18_scenario_conditional_probability_and_rates_on_segment(source_zone, 'sumatra', mu_type)
sz_andaman = ptha18_source_rate_env$get_PTHA18_scenario_conditional_probability_and_rates_on_segment(source_zone, 'andaman', mu_type)
sz_arakan = ptha18_source_rate_env$get_PTHA18_scenario_conditional_probability_and_rates_on_segment(source_zone, 'arakan', mu_type)
...
event_peak_stage_at_refpoint = ptha18$get_peak_stage_at_point_for_each_event(
    hazard_point_gaugeID = reference_point_gaugeID,
...
plot_scenario_stages_with_different_scenario_size_weightings<-function(
    ...
    pdf(paste0('Sampling_accuracy_fig_', pdf_output_name_extra, '.pdf'), 
        width=12, height=9)
