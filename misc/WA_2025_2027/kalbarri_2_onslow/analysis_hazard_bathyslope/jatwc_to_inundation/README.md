...
At this point you can plot the distribution of each warning category in each zone (currently does not give a special treatment for offshore islands)
```r
Rscript plot_distribution_of_H_statistics.R
```
