...
hazard_scenarios_dirname = '../../sources/hazard_bathyslope'

# Location of tarred raster files
# Each raster_output_files.tar contains a set of rasters
tarred_raster_files =
    Sys.glob('../../swals/OUTPUTS/ptha18-kalbarri2onslow-hazard_bathyslope/random_*/*/raster_output_files.tar')
...
reference_multidomain_dir =
    '../../swals/OUTPUTS/smallTestCase_kalbarri2onslow_20251218_16MPI-full-ambient_sea_level_0/RUN_20251218_224020940/'
