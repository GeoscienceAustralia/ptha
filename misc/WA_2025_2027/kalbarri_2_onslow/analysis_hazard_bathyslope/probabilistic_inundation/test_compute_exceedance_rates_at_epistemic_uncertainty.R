...
#
# We find the max-stage exceedance rate at site for a
# chosen threshold stage at the 84th percentile logic-tree
# uncertainty, considering only scenarios on the sunda2 source zone.
#
...
sourcezone_runs_base_dir = '../../swals/OUTPUTS/ptha18-kalbarri2onslow-hazard_bathyslope/random_sunda2/'
