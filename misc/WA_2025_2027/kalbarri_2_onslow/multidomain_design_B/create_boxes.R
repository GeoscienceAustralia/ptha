...
outdir_startname = 'kalbarri2onslow_domains_20251218_'
...
#
NUMBER_NESTING_LEVELS = 7 # Not counting global domain
...
nesting[[2]]$region = readOGR('kalbarri2onslow_C_level2/kalbarri2onslow_C_level2.shp', layer='kalbarri2onslow_C_level2')
names(nesting)[2] = 'kalbarri2onslow_C_level2'
nesting[[2]]$domain_size = nesting[[1]]$domain_size/3

nesting[[3]]$region = readOGR('kalbarri2onslow_C_level3/kalbarri2onslow_C_level3.shp', layer='kalbarri2onslow_C_level3')
names(nesting)[3] = 'kalbarri2onslow_C_level3'
nesting[[3]]$domain_size = nesting[[2]]$domain_size/3

nesting[[4]]$region = readOGR('kalbarri2onslow_C_level4/kalbarri2onslow_C_level4.shp', layer='kalbarri2onslow_C_level4')
names(nesting)[4] = 'kalbarri2onslow_C_level4'
nesting[[4]]$domain_size = nesting[[3]]$domain_size/3
nesting[[4]]$buffer_with_index = -1 # This is the finest domain, don't buffer with the next one before making the geometry

## Extras for Xmas/Cocos Island/Rodriguez
...
nesting[[6]]$region = readOGR('Xmas_cocos_level2/Xmas_cocos_level2.shp', layer='Xmas_cocos_level2')
names(nesting)[6] = 'Xmas_cocos_level2'
nesting[[6]]$domain_size = nesting[[5]]$domain_size/3
#nesting[[6]]$buffer_with_index = -1

nesting[[7]]$region = readOGR('Xmas_cocos_level3/Xmas_cocos_level3.shp', layer='Xmas_cocos_level3')
names(nesting)[7] = 'Xmas_cocos_level3'
nesting[[7]]$domain_size = nesting[[6]]$domain_size/5 # Keep this small since large domains spill into deep water (short timestep)
nesting[[7]]$buffer_with_index = -1
