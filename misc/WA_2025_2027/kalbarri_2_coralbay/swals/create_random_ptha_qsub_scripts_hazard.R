...
model_group_name = 'ptha18-kalbarri2coralbay-hazard'
model_names = paste0(model_group_name, '/', sourcezone_dirs, '/',
    'ptha18_random_scenarios_', gsub('.tif', '', basename(raster_files), fixed=TRUE))

jobs_per_qsub_file = 4 # Run this many models in a single qsub file (or less), to stay within NCI walltime limits
...
with(model_run_creation_env, {
    ...
    multidomain_design_control_namelist = 'multidomain_design_control/multidomain_kalbarri2coralbay_B_hazard.nml'
