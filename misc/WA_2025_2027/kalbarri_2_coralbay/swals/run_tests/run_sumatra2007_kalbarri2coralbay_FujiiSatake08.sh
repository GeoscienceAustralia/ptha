...
stage_file=../sources/like_historic/Sumatra2007/FujiiSatake2007/FujiiSatake08_2007_Sumatra_SUM_KAJIURA_SMOOTHED.tif
## No tidal adjustment
multidomain_design_namelist=./multidomain_design_control/multidomain_kalbarri2coralbay_B_historicaltsunamis.nml

# Model name
model_name=sumatra2007_FujiiSatake08_timevarying
