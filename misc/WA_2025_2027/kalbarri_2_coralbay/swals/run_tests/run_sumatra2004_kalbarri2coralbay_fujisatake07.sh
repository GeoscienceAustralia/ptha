...
stage_file=../sources/like_historic/sumatra2004/FujiSatake2007/FujiSatake2007_time_varying_forcing_realistic.csv
## No tidal adjustment
multidomain_design_namelist=./multidomain_design_control/multidomain_kalbarri2coralbay_B_historicaltsunamis.nml
# Model name
model_name=sumatra2004_FujiSatake2007_timevarying
