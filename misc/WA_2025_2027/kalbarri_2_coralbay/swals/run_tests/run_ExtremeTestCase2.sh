...
# Initial stage 
stage_file=../sources/test_sources/extreme_ptha18_source/sunda2_row_0107985_Mw_94_HS.tif

## With tidal adjustment
multidomain_design_namelist=./multidomain_design_control/multidomain_kalbarri2coralbay_B_hazard_with_more_outputs.nml

## No tidal adjustment
#multidomain_design_namelist=./multidomain_design_control/multidomain_kalbarri2coralbay_historicaltsunamis.nml

# Model name
model_name=extremeTestCase2_sunda2_row_0107985_Mw94_kalbarri2coralbay_B_tidaladjustment
