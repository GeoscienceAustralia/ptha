...
stage_file=../sources/like_historic/Java2006/java2006_FujiSatake_1kms/FujiSatake2006_Java2006_time_varying_forcing_instantaneous_horiz.csv
## No tidal adjustment
multidomain_design_namelist=./multidomain_design_control/multidomain_kalbarri2coralbay_B_historicaltsunamis.nml
# Model name
model_name=java2006_FujiiSatake2006_1kms_timevarying_horizontalcomp
