...
back_calculated_HS_rates_combination = sz_full$HS_event_rates
...
write.csv(random_scenario_info$unsegmented, paste0('random_scenarios_', source_zone, '_unsegmented_HS.csv'), row.names=FALSE)
...
write.csv(random_scenarios_mean_curve, 
          paste0('random_scenarios_', source_zone, '_logic_tree_mean_curve_HS.csv'), row.names=FALSE)
