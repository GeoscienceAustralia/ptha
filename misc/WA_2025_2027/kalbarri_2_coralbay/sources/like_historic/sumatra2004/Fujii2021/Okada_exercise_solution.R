...
#
#
x = read.table('Fujii_2021_joint_inversion_1.3kms.txt', header=TRUE, colClasses=rep('numeric', 7))
...
rupture_basename = 'Fuji21_andaman2004_unit_sources' # Name at the start of output files
make_plot = FALSE
