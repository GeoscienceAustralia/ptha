...
all_scenario_raster_tars = normalizePath(Sys.glob(
    '../../swals/OUTPUTS/ptha18-kalbarri2coralbay-hazard/random_*/ptha*/raster_output_files.tar'))
...
ptha_exceedance_rate_rasts = normalizePath(Sys.glob('../probabilistic_inundation/ptha18-kalbarri2coralbay-hazard/highres_depth_epistemic_uncertainty/84pc/ptha18-kalbarri2coralbay-hazard-depth_exrate_0.001_0.84_sum_of_source_zones/*.tif'))
