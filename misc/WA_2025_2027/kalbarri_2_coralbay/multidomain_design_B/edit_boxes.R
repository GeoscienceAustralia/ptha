...
nesting_levels_to_edit = paste0(
    'kalbarri2coralbay_B_domains_20260324_1_3_21_1_5/',
    c(
...
points_to_coarsen_shapefiles = c(
    "", "coarsen_level3_pts/coarsen_level3_pts.shp", "", "", "")
points_to_coarsen_layers = c(
    "", "coarsen_level3_pts", "", "", "")

theta_to_reduce_shapefiles = c(
    "", "", "reduce_theta_level4_pts/reduce_theta_level4_pts.shp", "", "")
theta_to_reduce_layers = c(
    "", "", "reduce_theta_level4_pts", "", "")
