...
output_directory = paste0(basename(dirname(MD_BASE_DIR)), '-', VARIABLE_NAME, '-LogicTreeMean-', source_zone) # "ptha18-midwest-sealevel60cm-depth-LogicTreeMean-outerrisesunda"
