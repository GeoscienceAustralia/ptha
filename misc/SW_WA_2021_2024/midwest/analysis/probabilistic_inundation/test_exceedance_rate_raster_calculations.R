...
comparison_calculation_RDS = '../max_stage_at_a_point/rdata/nonlinear_model_curves_and_ptha18_curves_113.0708_-28.5679.RDS'

source_zone = 'sunda2'
# Tarred models
tarred_multidomain_dirs = Sys.glob(
    '../../swals/OUTPUTS/ptha18-midwest-sealevel60cm/random_sunda2/ptha*/RUN*.tar')
