...
model_names = paste0('ptha18-GreaterPerth-sealevel60cm-reviseddomain-highres/', sourcezone_dirs, '/',
...
with(model_run_creation_env, {
    ...
    load_balance_file = 'load_balance_files/load_balance_020322_0.5_0.166666666666667_0.0333333333333333_24MPI.txt'
...
for(i in 1:number_of_qsub_files){
    output_qsub_filename = paste0('run_greaterperth_sealevel60cm_reviseddomain_highres_', 1000 + i, '.sh')
