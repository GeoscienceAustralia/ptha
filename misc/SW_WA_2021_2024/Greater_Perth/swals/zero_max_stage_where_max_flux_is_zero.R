...
#max_stage_rasts = Sys.glob('OUTPUTS/Fuji_andaman2004_24hrs_domain010322_timevaryingRealistic-full-ambient_sea_level_0.0/RUN_20220303_092730617/max_stage*.tif')
max_stage_rasts = Sys.glob('OUTPUTS/Fuji_sumatra2005_domains010322_newProcessDataToSend-full-ambient_sea_level_0.0/RUN_20220303_092805508/max_stage*.tif')
