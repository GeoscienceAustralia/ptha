...
outdir_startname = 'domains_010322_'
...
nesting[[2]]$region = readOGR('second_level_nesting_010322/second_level_nesting.shp', layer='second_level_nesting')
...
nesting[[3]]$region = readOGR('third_level_nesting_010322/third_level_nesting.shp', layer='third_level_nesting')
