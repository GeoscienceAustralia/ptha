...
max_stages_char = paste0('_', 
    as.character(c(0.001, 0.1, 0.2, 0.3, 0.5, 0.75, 1.0, 1.25, 1.5, 1.75, 2, 2.5, 3, 3.5, 4, 5, 6, 7, 8, 9, 10)), 
    '.tif')
# And these domains -- 559 in total
...
outerrisesunda_tifs = Sys.glob('ptha18-GreaterPerth-sealevel60cm-reviseddomain-highres-random_outerrisesunda-/*.tif')
# tifs for all domains, all max-stages, all segments and unsegmented model, sunda2
sunda2_tifs = Sys.glob('ptha18-GreaterPerth-sealevel60cm-reviseddomain-highres-random_sunda2-/*.tif')
