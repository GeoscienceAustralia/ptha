...
#source_zone_dirs = paste0('highres_epistemic_uncertainty/84pc/', 
#                          'ptha18-GreaterPerth-sealevel60cm-depth_exrate_0.001_84pc_', source_zones, '/')

## 16th percentile
#source_zones = c('outerrisesunda', 'sunda2')
#source_zone_dirs = paste0('highres_epistemic_uncertainty/16pc/', 
#                          'ptha18-GreaterPerth-sealevel60cm-depth_exrate_0.001_0.16_', source_zones, '/')

## Revised runs
## 84th percentile
#source_zones = c('outerrisesunda', 'sunda2')
#source_zone_dirs = paste0('reviseddomains_080422/highres_epistemic_uncertainty/84pc/', 
#    'ptha18-GreaterPerth-sealevel60cm-reviseddomain-highres-depth_exrate_0.001_0.84_', source_zones, '/')

# Revised runs
# 16th percentile
source_zones = c('outerrisesunda', 'sunda2')
source_zone_dirs = paste0('reviseddomains_080422/highres_epistemic_uncertainty/16pc/', 
    'ptha18-GreaterPerth-sealevel60cm-reviseddomain-highres-depth_exrate_0.001_0.16_', source_zones, '/')
