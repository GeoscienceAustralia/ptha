...
tarred_raster_files =
    Sys.glob('../../swals/OUTPUTS/ptha18-GreaterPerth-sealevel60cm-reviseddomain-highres/*/*/raster_output_files.tar')
...
reference_multidomain_dir =
    '../../swals/OUTPUTS/Fuji_sumatra2005_domains010322_newProcessDataToSend-full-ambient_sea_level_0.0/RUN_20220303_092805508/'
...
get_max_stage_at_point<-function(tarred_raster_file, raster_filename, XIND, YIND, target_point, coordinate_errtol){
    ...
    ## ALTERNATIVE:
    # p1 = st_point(target_point) # Class sfg
    # pts = st_sfc(p1, crs=st_crs(r1)) # Class sfc with same projection as the raster
    # st_extract(r1, pts) # Contains the values at the points

    ##   Simple feature collection with 1 feature and 1 field
    ##   Geometry type: POINT
    ##   Dimension:     XY
    ##   Bounding box:  xmin: 115.2342 ymin: -31.6791 xmax: 115.2342 ymax: -31.6791
    ##   Geodetic CRS:  WGS 84
    ##     max_stage_domain_350.tif                  geometry
    ##   1                0.6035963 POINT (115.2342 -31.6791)
}
...
#
# Compare nonlinear model (24 hours) and PTHA18 (36 hours, frictionless)
...
plot(scenario_max_stages$ptha18_max_stage, scenario_max_stages$nonlinear_max_stage_minus_MSL,
     ...
     ylab='Highres model max-stage (24 hrs, nonlinear with friction)',
