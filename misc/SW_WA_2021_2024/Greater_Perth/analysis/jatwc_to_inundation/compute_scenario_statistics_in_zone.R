...
scenario_elevation = raster('../../swals/OUTPUTS/Fuji_andaman2004_24hrs_domain010322_timevaryingRealistic-full-ambient_sea_level_0.0/RUN_20220303_092730617/elevation_all.vrt')

## Not needed (used for a quick check)
# scenario_max_stage = raster('../../swals/OUTPUTS/Fuji_andaman2004_24hrs_domain010322_timevaryingRealistic-full-ambient_sea_level_0.0/RUN_20220303_092730617/all_max_stage.vrt')
...
get_offshore_points_to_compute_JATWC_H<-function(warning_zone, scenario_elevation, 
    ...
    if(file.exists(output_file)){
        ...
        # Get their elevation -- FIXME: Consider stars::st_extract
        ...
        # FIXME: For the general case we might want to remove isolated clumps of points here
        ...
        # Keep points in the polygon that are deep enough
...
make_max_stage_rast_and_get_JATWC_H<-function(scenario_raster_tar, sample_points, STARTING_DIR){
    ...
    # FIXME: Consider stars:: -- read_stars(st_mosaic( list-of-files, options=c('-resolution', 'highest')))
