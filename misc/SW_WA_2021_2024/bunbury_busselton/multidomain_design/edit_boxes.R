...
# 
boxes_to_edit = Sys.glob('domains_301122_0.5_0.166666666666667_0.0333333333333333_0.00555555555555556/*level_nesting.csv')
...
for(i in 1:length(boxes_to_edit)){
    ...
    if(basename(boxes_to_edit[i]) == 'second_level_nesting.csv'){
        ...
        library(rgdal) # Replace with rptha in future (which already provides a readOGR alternative)
