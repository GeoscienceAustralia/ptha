...
##      Fuji_sumatra2005_24hrs_domain301122 \
##      full \
...
##      "./load_balance_files/load_balance_301122_24MPI.txt" \
##      0.0 > outfile.log
##  
##
...
model_names = paste0('ptha18-BunburyBusseltonRevised-sealevel60cm/', sourcezone_dirs, '/',
...
with(model_run_creation_env, {
    ...
    # Load balance file
    load_balance_file = 'load_balance_files/load_balance_301122_24MPIb.txt'

    # Four levels of nested domains
    first_level_nesting_file = "../multidomain_design/domains_301122_0.5_0.166666666666667_0.0333333333333333_0.00555555555555556/first_level_nesting_edited.csv"
    second_level_nesting_file = "../multidomain_design/domains_301122_0.5_0.166666666666667_0.0333333333333333_0.00555555555555556/second_level_nesting_edited.csv"
    third_level_nesting_file =  "../multidomain_design/domains_301122_0.5_0.166666666666667_0.0333333333333333_0.00555555555555556/third_level_nesting_edited.csv"
    fourth_level_nesting_file = "../multidomain_design/domains_301122_0.5_0.166666666666667_0.0333333333333333_0.00555555555555556/fourth_level_nesting_edited.csv"
    ...
    if(number_nodes != 6 | run_type != 'full' ){
    ...
    make_job_command<-function(raster_file, model_name){
        ...
        job_command = paste0(
            ...
            first_level_nesting_file, slash_newline,
            second_level_nesting_file, slash_newline,
            third_level_nesting_file, slash_newline,
            fourth_level_nesting_file, slash_newline,
            load_balance_file, slash_newline,
            ambient_sea_level,
            ' > outfile.log')
...
for(i in 1:number_of_qsub_files){
    output_qsub_filename = paste0('run_BunburyBusselton_sealevel60cm_', 1000 + i, '.sh')
