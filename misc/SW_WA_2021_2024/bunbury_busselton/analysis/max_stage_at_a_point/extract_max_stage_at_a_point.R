...
tarred_raster_files =
    Sys.glob('../../swals/OUTPUTS/ptha18-BunburyBusseltonRevised-sealevel60cm/*/*/raster_output_files.tar')
...
reference_multidomain_dir =
    '../../swals/OUTPUTS/Fuji_andaman2004_24hrs_domain301122-full-ambient_sea_level_0.0/RUN_20230308_144722774/'
