...
#
# Run from inside ptha18-BunburyBusseltonRevised-sealevel60cm/highres_with_variance
#
source_zone_dirs = paste0('ptha18-BunburyBusseltonRevised-sealevel60cm-random_', source_zones, '-')
summed_results_dir = 'ptha18-BunburyBusseltonRevised-sealevel60cm-sum_of_source_zones'
