...
# We used a special treatment of the initial stage in the Vasse estuary
...
ptha_exceedance_rate_rasts = normalizePath(Sys.glob('../probabilistic_inundation/ptha18-BunburyBusseltonRevised-sealevel60cm/highres_epistemic_uncertainty/84pc/ptha18-BunburyBusseltonRevised-sealevel60cm-depth_exrate_0.001_0.84_sum_of_source_zones/*.tif'))
