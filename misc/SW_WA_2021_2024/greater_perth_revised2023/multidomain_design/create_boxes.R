...
outdir_startname = 'domains_2023_08_29_'
...
nesting[[1]]$region = readOGR('first_level_nesting_010322/first_level_nesting.shp', layer='first_level_nesting')
...
nesting[[2]]$region = readOGR('second_level_nesting_290823/second_level_nesting.shp', layer='second_level_nesting')
...
nesting[[3]]$region = readOGR('third_level_nesting_290823/third_level_nesting.shp', layer='third_level_nesting')
