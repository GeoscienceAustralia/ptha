...
MAXDEPTH=adaptive_maximum # 100.0 # Upper limit to uniroot search (for efficiency)
DEPTHTOL=0.01 # Tolerance for uniroot search
OUTPUTDIR=greaterperth_2023_revised_highres_domains_max_flux_at_epistemic_uncertainty_84pc
