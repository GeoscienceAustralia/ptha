...
reference_raster_tar_file = Sys.glob(paste0(
    '../../swals/OUTPUTS/ptha18-GreaterPerth2023-sealevel60cm/random*/ptha18*/raster_output_files.tar'))[1]
...
source_zone_modelled_tsunami_scenario_basedirs = list(
    'outerrisesunda' = '../../swals/OUTPUTS/ptha18-GreaterPerth2023-sealevel60cm/random_outerrisesunda/',
    'sunda2'         = '../../swals/OUTPUTS/ptha18-GreaterPerth2023-sealevel60cm/random_sunda2/')
