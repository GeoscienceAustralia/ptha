...
sample_points = get_offshore_points_to_compute_JATWC_H(
    warning_zone, scenario_elevation, asfm$jatwc_depth_limit, asfm$jatwc_dlon_dlat)
...
library(parallel)
all_JATWC_H = mclapply(as.list(asfm$all_scenario_raster_tars), parallel_fun, mc.cores=MC_CORES)
