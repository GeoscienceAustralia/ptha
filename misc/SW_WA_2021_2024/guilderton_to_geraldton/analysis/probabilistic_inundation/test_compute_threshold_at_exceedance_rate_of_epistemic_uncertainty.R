...
#
# We find the max-stage threshold at site c(113.0708, -28.5679) for a
# for a given exceedance-rate at the 84th percentile logic-tree
# uncertainty, considering the sum over source zones.
#
...
stage_threshold = 1. # MUST correspond to a stage threshold in the RDS file
STAGE_TOL = 0.001 # Error tolerance for uniroot.
epistemic_uncertainty_percentile = 0.84
comparison_calculation_RDS = '../max_stage_at_a_point/rdata/epistemic_percentile_uncertainties_nonlinear_model_113.0708_-28.5679.RDS'
