...
tarred_raster_files =
    Sys.glob('../../swals/OUTPUTS/ptha18-midwest-sealevel60cm/*/*/raster_output_files.tar')
...
reference_multidomain_dir =
    '../../swals/OUTPUTS/Sumatra2004_FujiiSatake2007_timevarying-full-ambient_sea_level_0.0/RUN_20231128_100150493/'
...
if(DO_EPISTEMIC_UNCERTAINTY_CALCULATIONS){
    ...
    file_home = '../../../../../../AustPTHA/CODE/ptha_mm/ptha_access/get_detailed_PTHA18_source_zone_info.R'
