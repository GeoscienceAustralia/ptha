...
# Zones for maps
NO_THREAT_ZONE = readOGR('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/jatwc_inundation_zones/Bunbury-Geographe-Coast/Bunbury-Geographe-Coast_no_threat_with-PTHA-exrate-limit_84pc_4e-04', verbose=FALSE)
MARINE_WARNING_ZONE = readOGR('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/jatwc_inundation_zones/Bunbury-Geographe-Coast/Bunbury-Geographe-Coast_marine_warning_with-PTHA-exrate-limit_84pc_4e-04', verbose=FALSE)
LAND_WARNING_ZONE = readOGR('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/jatwc_inundation_zones/Bunbury-Geographe-Coast/Bunbury-Geographe-Coast_land_warning_with-PTHA-exrate-limit_84pc_4e-04', verbose=FALSE)
...
##
TIF_FILES = list()
TIF_FILES$max_stage_1in2500_84pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/max_stage_1in2500_84pc/*.tif')
TIF_FILES$max_depth_1in2500_84pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/max_depth_1in2500_84pc/*.tif') 
TIF_FILES$max_flux_1in2500_84pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/max_flux_1in2500_84pc/*.tif') 
TIF_FILES$max_speed_1in2500_84pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/max_speed_1in2500_84pc/*.tif') 
TIF_FILES$elevation = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/elevation_in_model/*.tif')
TIF_FILES$inundation_rate_ltm = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/inundation_rate_logic_tree_mean/*.tif')
TIF_FILES$inundation_rate_84pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/inundation_rate_84pc/*.tif')
TIF_FILES$inundation_rate_16pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/bunbury_busselton/inundation_rate_16pc/*.tif')
...
make_region_plot<-function(i, out_dir='.'){
    ...
    k = 1:4 # Visible colours #which(!is.na(inundation_classmat_col))
