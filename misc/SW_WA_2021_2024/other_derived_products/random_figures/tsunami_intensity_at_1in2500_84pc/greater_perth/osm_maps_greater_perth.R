...
# Zones for maps
NO_THREAT_ZONE = readOGR('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/jatwc_inundation_zones/Perth-Coast/Perth-Coast_no_threat_with-PTHA-exrate-limit_84pc_4e-04', verbose=FALSE)
MARINE_WARNING_ZONE = readOGR('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/jatwc_inundation_zones/Perth-Coast/Perth-Coast_marine_warning_with-PTHA-exrate-limit_84pc_4e-04', verbose=FALSE)
LAND_WARNING_ZONE = readOGR('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/jatwc_inundation_zones/Perth-Coast/Perth-Coast_land_warning_with-PTHA-exrate-limit_84pc_4e-04', verbose=FALSE)
...
##
TIF_FILES = list()
TIF_FILES$max_stage_1in2500_84pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/max_stage_1in2500_84pc/*.tif')
TIF_FILES$max_depth_1in2500_84pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/max_depth_1in2500_84pc/*.tif') 
TIF_FILES$max_flux_1in2500_84pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/max_flux_1in2500_84pc/*.tif') 
TIF_FILES$max_speed_1in2500_84pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/max_speed_1in2500_84pc/*.tif') 
TIF_FILES$elevation = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/elevation_in_model/*.tif')
TIF_FILES$inundation_rate_ltm = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/inundation_rate_logic_tree_mean/*.tif')
TIF_FILES$inundation_rate_84pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/inundation_rate_84pc/*.tif')
TIF_FILES$inundation_rate_16pc = Sys.glob('../../../WA_tsunami_modelling_2021_2024_definitive_outputs/model_outputs/greater_perth/inundation_rate_16pc/*.tif')
...
make_region_plot<-function(i, out_dir='.'){
    ...
    regional_plot(lower_left = plot_ll, upper_right=plot_ur, plotvar='max_stage_1in2500_84pc', 
        zlim=c(0.6,5.6), backdrop='osm', colpal=palDepthStage_trans)
