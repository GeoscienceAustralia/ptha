...
source_zones_and_samples = list(
    'kermadectonga2'         = round(NTOT * 0.33),
    'solomon2'               = round(NTOT * 0.25),
    'newhebrides2'           = round(NTOT * 0.25),
    'southamerica'           = round(NTOT * 0.17)
    )
...
other_test_points = list(
    ...
    "heron_one_tree" = c(152.15084, -23.36871), # 100 m deep
