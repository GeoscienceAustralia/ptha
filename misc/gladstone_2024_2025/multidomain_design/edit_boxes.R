...
nesting_levels_to_edit = paste0(
    'domains_1_3_15_15/nesting_level_',
    c('1.csv', '2.csv', '3.csv', '4.csv'))
...
points_to_coarsen_shapefiles = c(
    'first_level_domains_to_coarsen/first_level_domains_to_coarsen.shp',
    'second_level_domains_to_coarsen/second_level_domains_to_coarsen.shp',
    '',
    ''
)
points_to_coarsen_layers = c(
    "first_level_domains_to_coarsen",
    "second_level_domains_to_coarsen",
    "",
    ""
)
