#
# Compare the min-stage exceedance-rate against a separately
# calculated value at a point (from '../../min_stage_at_a_point')
#
asfm = new.env()
...
# Get "min-stage-exceedance' of "MSL + 0.5"
MSL = 0.0
exceedance_threshold = MSL + 0.5
comparison_calculation_RDS = 
    'min_stage_at_a_point/ptha/data/nonlinear_model_curves_and_ptha18_curves_152.66667175293_-23.333333961162.RDS'
