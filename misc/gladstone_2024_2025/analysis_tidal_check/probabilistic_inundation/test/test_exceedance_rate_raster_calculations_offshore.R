...
## Inputs 
##
target_point = c(152.66667175293, -23.333333961162)

# Get "max-stage-exceedance' of "MSL + 0.5"
MSL = 0.0
exceedance_threshold = MSL + 0.5
comparison_calculation_RDS = 
    '../../max_stage_at_a_point/ptha18_tidal_check/sea_level_vary/data/nonlinear_model_curves_and_ptha18_curves_152.66667175293_-23.3333339691162.RDS'
test_source_name = 'kermadectonga2'

# Tarred models
tarred_multidomain_dirs = Sys.glob(
    '../../../swals/OUTPUTS/v6/ptha18_tidal_check/sea_level_vary/random_kermadectonga2/ptha*/RUN*.tar')

# Logic tree mean scenarios
scenario_databases = list()
scenario_databases$logic_tree_mean_curve_HS = read.csv(
    "../../../sources/hazard/tide_check_50/random_kermadectonga2/random_scenarios_kermadectonga2_logic_tree_mean_HS.csv")
