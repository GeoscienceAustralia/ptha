...
target_point = rbind(c(152.66667175293, -23.3333339691162))
...
comparison_calculation_RDS_epi =
    '../../max_stage_at_a_point/ptha18_tidal_check/sea_level_vary/data/epistemic_percentile_uncertainties_nonlinear_model_152.66667175293_-23.3333339691162.RDS'
comparison_calculation_RDS_scenarios =
    '../../max_stage_at_a_point/ptha18_tidal_check/sea_level_vary/data/scenario_max_stages_152.66667175293_-23.3333339691162.RDS'

tmp_output_dir = 'tmp_threshold_at_epistemic_uncertainty'
...
tmp_output_dir = 'tmp_threshold_at_epistemic_uncertainty_adaptive_domain'
dir.create(tmp_output_dir, showWarnings=FALSE)
existing_tifs = Sys.glob(paste0(tmp_output_dir, '/*.tif'))
if(length(existing_tifs) > 0){
    clear_file = file.remove(existing_tifs)
