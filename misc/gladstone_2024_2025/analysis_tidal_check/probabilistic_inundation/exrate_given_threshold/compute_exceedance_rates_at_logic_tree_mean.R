...
usage_msg = paste0(
    'Usage example \n',
    'To compute exceedance rates for depth > 0.001 and 0.5m at the logic-tree-mean\n',
    '',
    'Rscript compute_exceedance_rates_at_logic_tree_mean.R ',
    '../../../swals/OUTPUTS/v6/ptha18_tidal_check/sea_level_2.145/random_kermadectonga2 ',
    '132 ',
    'depth ',
    '0.001 0.5\n'
)
...
# ## debugging inputs
# MD_BASE_DIR = "../../../swals/OUTPUTS/v6/ptha18_tidal_check/sea_level_2.145/random_kermadectonga2"
# MAX_DOMAIN_INDEX = 132  
# VARIABLE_NAME = "depth"
# EXCEEDANCE_THRESHOLDS = c(0.001)
...
all_source_samples = sm$all_source_samples # The random scenario files for the logic-tree-mean
...
try_compute_exceedance_rates_and_error_variance_on_tile<-function(
    ...
    result = try(errc$compute_exceedance_rates_and_error_variance_on_tile_with_importance_sampling(
        input_domain_index_and_scenarios_name_and_exrate,
        tarred_multidomain_dirs, 
        scenario_databases, 
        output_directory, 
...
# To run in parallel, make a list with each source representation and
# domain-index and exceedance-threshold held together
