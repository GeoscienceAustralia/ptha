...
# e.g. 
#   Rscript compute_mean_exrate_upper_CI.R ptha18_tidal_check/sea_level_vary/highres_depth_with_variance/ depth 0.001
#   Rscript compute_mean_exrate_upper_CI.R ptha18_tidal_check/sea_level_vary/highres_max_stage_with_variance/ max_stage 4.63
#
library(terra)
