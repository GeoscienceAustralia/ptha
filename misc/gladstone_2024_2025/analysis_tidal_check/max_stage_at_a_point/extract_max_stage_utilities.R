...
plot_tsunami_maxima_in_nonlinear_model_and_PTHA18<-function(target_point, scenario_max_stages, dir_name){
    ...
    out_file = paste0(dir_name, '/Tsunami_maxima_in_PTHA18_and_Nonlinear_Model_', target_point[1], '_', target_point[2], '.png')
    ...
    out_file = paste0(dir_name, '/Tsunami_maxima_in_PTHA18_and_Nonlinear_Model_relative_', target_point[1], '_', target_point[2], '.png')
...
plot_logic_tree_mean_exrate_curves_from_nonlinear_model_and_PTHA18<-function(
    ...
    out_file = paste0(dir_name, '/Exceedance_Rates_in_PTHA18_and_Sampled_Scenarios_using_PTHA18_max_stages_', 
        target_point[1], '_', target_point[2], '.png')
    NPANEL = length(names(nonlinear_model_curves))
    HT = 7.5
    WD = HT * NPANEL
    ...
    out_file = paste0(dir_name, '/Exceedance_Rates_Summed_in_PTHA18_and_Sampled_scenarios_using_PTHA18_max_stages_',
        target_point[1], '_', target_point[2], '.png')
    png(out_file, width=HT, height=HT, units='in', res=300)
    options(scipen=5)
    plot(ptha18_combined_curve, t='l', log='xy', ylim=EXRATE_PLOT_YLIM, col='skyblue', lwd=3,
