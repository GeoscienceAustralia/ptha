...
reference_multidomain_dir =
    '../../swals/OUTPUTS/model_load_balanced-test_load_balance-ambient_sea_level_0/RUN_20241031_162002201'
...
out_file = paste0(path_data, 'scenario_max_stages_', target_point[1], '_', target_point[2], '.RDS')
...
#
plot_tsunami_maxima_in_nonlinear_model_and_PTHA18(target_point, scenario_max_stages, path_plot)
