...
reference_raster_tar_file = Sys.glob('../../swals/OUTPUTS/ptha18-NSW2023-ID4186.3-sealevel110cm/*/*/raster_output_files.tar')[1]
...
get_scenario_metadata_from_md_base_dir<-function(MD_BASE_DIR){
    ...
    scenario_base = paste0('../../sources/hazard/scenarios_ID4186.3/random_', source_zone, '/')
