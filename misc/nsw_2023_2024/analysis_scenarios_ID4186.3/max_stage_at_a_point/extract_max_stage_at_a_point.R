...
importance_sampling_scenarios_logic_tree_mean = list(
    alaskaaleutians = read.csv('../../sources/hazard/scenarios_ID4186.3/random_alaskaaleutians/random_scenarios_alaskaaleutians_logic_tree_mean_HS.csv'),
    kermadectonga2 = read.csv('../../sources/hazard/scenarios_ID4186.3/random_kermadectonga2/random_scenarios_kermadectonga2_logic_tree_mean_HS.csv'),
    newhebrides2 = read.csv('../../sources/hazard/scenarios_ID4186.3/random_newhebrides2/random_scenarios_newhebrides2_logic_tree_mean_HS.csv'),
    outerrise_kermadectonga = read.csv('../../sources/hazard/scenarios_ID4186.3/random_outerrise_kermadectonga/random_scenarios_outerrise_kermadectonga_logic_tree_mean_HS.csv'),
    outerrisenewhebrides = read.csv('../../sources/hazard/scenarios_ID4186.3/random_outerrisenewhebrides/random_scenarios_outerrisenewhebrides_logic_tree_mean_HS.csv'),
    outerrise_puysegur = read.csv('../../sources/hazard/scenarios_ID4186.3/random_outerrise_puysegur/random_scenarios_outerrise_puysegur_logic_tree_mean_HS.csv'),
    puysegur2 = read.csv('../../sources/hazard/scenarios_ID4186.3/random_puysegur2/random_scenarios_puysegur2_logic_tree_mean_HS.csv'),
    solomon2 = read.csv('../../sources/hazard/scenarios_ID4186.3/random_solomon2/random_scenarios_solomon2_logic_tree_mean_HS.csv'),
    southamerica = read.csv('../../sources/hazard/scenarios_ID4186.3/random_southamerica/random_scenarios_southamerica_logic_tree_mean_HS.csv'))
