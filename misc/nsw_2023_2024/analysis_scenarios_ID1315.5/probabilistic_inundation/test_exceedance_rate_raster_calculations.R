...
tarred_multidomain_dirs = Sys.glob( ## Here we match both '.tar' and '.tar.bz2'
    '../../swals/OUTPUTS/ptha18-NSW2023-ID1315.5-sealevel110cm/random_kermadectonga2/ptha*/RUN*.ta*') 

# Logic tree mean scenarios
scenario_databases = list()
scenario_databases$logic_tree_mean_curve_HS = read.csv(
    '../../sources/hazard/scenarios_ID1315.5/random_kermadectonga2/random_scenarios_kermadectonga2_logic_tree_mean_HS.csv')
