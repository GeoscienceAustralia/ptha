...
print('NOTE: This script does not include code to create and include the land warning zone clipped in areas with max-stage less than a threshold (as it was created later). Add that in if needed')
