...
#png(paste0('Kermadec2021_east_coast_', output_name_tag, '.png'), width=12, height=15, units='in', res=300)
png(paste0('Kermadec2021_east_coast_WIDE_', output_name_tag, '.png'), width=24, height=15, units='in', res=300)
par(mar=c(0, 3, 0, 0))
