...
target_sites_in_order = rev(c(
    ...
    "PortKembla_1min_BOM",
    "PortKembla_GrainTerminal_1min_PA",
    "Bundeena_1min_DPIE",
    "Sydney_Botany_Bay_Pilot_Jetty_1min_PA",
    "Sydney_FortDenison_1min_PA_b",
...
#png(paste0('NewHebrides2021_east_coast_', output_name_tag, '.png'), width=12, height=15, units='in', res=300)
png(paste0('NewHebrides2021_east_coast_WIDE_', output_name_tag, '.png'), width=24, height=15, units='in', res=300)
par(mar=c(0, 3, 0, 0))
