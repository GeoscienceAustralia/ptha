...
mpiexec -np 16 --map-by numa:SPAN --bind-to numa -x OMP_NUM_THREADS=13 -x OMP_PROC_BIND=true ./model_sapphirerapids \
    ...
    'multidomain_design_control_NNL4_1arcminoffshore_mimicdispersion.nml' \
    run_NewHebrides2021_GusmanWithKajiura_1arcminoffshore_mimicdispersion full 0.0 > outfile.log
