...
#    run_kt43731_40h_NNL4 full 1.0 > outfile.log

#OMP_NUM_THREADS=13 mpiexec -np 16 --map-by ppr:4:socket:PE=13 ./model_sapphirerapids \
mpiexec -np 16 --map-by numa:SPAN --bind-to numa -x OMP_NUM_THREADS=13 -x OMP_PROC_BIND=true ./model_sapphirerapids \
    '../../../../east_australian_coast_2021_02/sources/kt_multi_site_selection/kermadectonga2_stochastic_43731_9.4_10000.tif' \
    'multidomain_design_control_NNL4_1arcminoffshore_12hrs.nml' \
    run_kt43731_12h_NNL4_1arcminoffshore full 1.0 > outfile.log
