...
mpiexec -np 16 --map-by numa:SPAN --bind-to numa -x OMP_NUM_THREADS=13 -x OMP_PROC_BIND=true ./model_sapphirerapids \
    '../sources/like_historic/Sumatra2004/PTHA18_VAUS107476/sumatra2004-batch2_variable_area_uniform_slip_107476_count_1.tif' \
    'multidomain_design_control_NNL4_1arcminoffshore.nml' \
    run_sumatra2004_PTHA18VAUS107476_1arcminoffshore full 0.0 > outfile.log
