...
model_names = paste0('ptha18-NSW2023-ID710.5-sealevel110cm/', sourcezone_dirs, '/',
...
for(i in 1:number_of_qsub_files){
    output_qsub_filename = paste0('run_ptha18_NSW2023_ID710.5_sealevel110cm_', 1000 + i, '.sh')
