...
mpiexec -np 16 --map-by numa:SPAN --bind-to numa -x OMP_NUM_THREADS=13 -x OMP_PROC_BIND=true ./model_sapphirerapids \
    '../sources/like_historic/NewHebrides2021/PTHA_HS4666/newhebrides2021-batch3_heterogeneous_slip_4666_count_1.tif' \
    'multidomain_design_control_NNL4_1arcminoffshore.nml' \
    run_NewHebrides2021_PTHA18HS4666_1arcminoffshore full 0.0 > outfile.log
