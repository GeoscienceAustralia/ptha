...
#
source_data_file = '../sources/like_historic/Sumatra2004/FujiSatake2007/rupture_summary.csv'
source_data = read.csv(source_data_file)
source_tifs = paste0(dirname(source_data_file), '/Fuji_andaman2004_unit_sources_', 1:nrow(source_data), '_KAJIURA_SMOOTHED.tif')
