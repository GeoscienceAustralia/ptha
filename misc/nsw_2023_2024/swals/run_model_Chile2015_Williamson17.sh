...
mpiexec -np 16 --map-by numa:SPAN --bind-to numa -x OMP_NUM_THREADS=13 -x OMP_PROC_BIND=true ./model_sapphirerapids \
    '../sources/like_historic/Chile2015/WilliamsonEtAl2017/Williamson_chile_sources_SUM_KAJIURA_SMOOTHED.tif' \
    'multidomain_design_control_NNL4_1arcminoffshore.nml' \
    run_Chile2015_Williamson_1arcminoffshore full 0.0 > outfile.log
