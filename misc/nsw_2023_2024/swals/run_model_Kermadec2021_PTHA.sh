...
mpiexec -np 16 --map-by numa:SPAN --bind-to numa -x OMP_NUM_THREADS=13 -x OMP_PROC_BIND=true ./model_sapphirerapids \
    '../sources/like_historic/KermadecTonga2021/PTHA_HS27533/kermadec2021-batch3_heterogeneous_slip_27533_count_1.tif' \
    'multidomain_design_control_NNL4_1arcminoffshore.nml' \
    run_Kermadec2021_PTHA18HS27533_1arcminoffshore full 0.0 > outfile.log
