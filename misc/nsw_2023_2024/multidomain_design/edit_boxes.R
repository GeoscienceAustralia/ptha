...
#nesting_levels_to_edit = paste0('domains_2023_04_08_0.5_0.166666666666667/',
#nesting_levels_to_edit = paste0('domains_2023_08_23_0.5_0.166666666666667/',
#    c('first_level_nesting.csv', 'second_level_nesting.csv'))
#nesting_levels_to_edit = paste0('domains_2023_09_07_0.5_0.166666666666667_0.0333333333333333/',
#    c('first_level_nesting.csv', 'second_level_nesting.csv', 'third_level_nesting.csv'))
#nesting_levels_to_edit = paste0('domains_2023_09_11_with_NZ_0.5_0.166666666666667_0.0333333333333333/',
#    c('first_level_nesting.csv', 'second_level_nesting.csv', 'third_level_nesting.csv'))
nesting_levels_to_edit = paste0('domains_2023_11_09_with_LHI_Middleton_Norfolk0.5_0.166666666666667_0.0333333333333333/',
    c('first_level_nesting.csv', 'second_level_nesting.csv', 'third_level_nesting.csv'))
...
points_to_coarsen_shapefiles = c('', 'nearshore_zone_domains_to_coarsen', 'highres_sites_LHI_domains_to_coarsen')
