...
target_pt =c(152.408264, -32.725056) # gauge ID 4186.3 -- in between ID710.5 and ID1315.5, and shallower water (~110m)

# Number of samples (sampling with replacement, so likely fewer scenarios to simulate)
NTOT = 360 

# For reproducible randomness - CHANGE THIS BETWEEN SAMPLES.
