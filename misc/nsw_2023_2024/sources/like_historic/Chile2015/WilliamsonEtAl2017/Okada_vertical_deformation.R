# Example from 
#
# Williamson, A., Newman, A. and Cummins, P. 2017 Reconstruction of coseismic
# slip from the 2015 Illapel earthquake using combined geodetic and tsunami
# waveform data Journal of Geophysical Research (Solid Earth), 122, 2119-2130 
#
# The table '*' reports that coordinates/depth are at centre of unit-source
#
...
#
#
x = read.csv('subfaults.csv', colClasses='numeric')
lon = 360 + x$lon
lat = x$lat
width  = rep(25, length(lon)) # rupture width in km.
length = rep(25, length(lon)) # rupture length in km
...
rupture_basename = 'Williamson_chile_sources' # Name at the start of output files
make_plot = FALSE
