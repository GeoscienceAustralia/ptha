...
library(raster)
free_surface = rasterFromXYZ(cbind(lonlat, z), crs=CRS("EPSG:4326"))

writeRaster(free_surface, file='Ho_Chile1960_initial_displacement.tif', options=c('COMPRESS=DEFLATE'), overwrite=TRUE)
