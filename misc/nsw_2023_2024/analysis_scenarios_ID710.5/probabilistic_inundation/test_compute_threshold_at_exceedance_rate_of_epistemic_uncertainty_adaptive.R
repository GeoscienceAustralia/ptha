...
run_command = paste0('Rscript compute_threshold_at_exceedance_rate_of_epistemic_uncertainty_percentile_adaptive.R', ' ',
    'max_stage', ' ', 
    domain_index, ' ', 
    epistemic_uncertainty_percentile, ' ',
    exrate_for_test, ' ',
    'adaptive_minimum ', #stage_threshold - 1, ' ',
    'adaptive_maximum ', #stage_threshold + 1, ' ',
    STAGE_TOL, ' ',
    tmp_output_dir)
system(run_command)
