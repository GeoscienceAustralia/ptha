...
tarred_multidomain_dirs = Sys.glob(
    '../../swals/OUTPUTS/ptha18-NSW2023b-ID710.5-sealevel110cm/random_kermadectonga2/ptha*/RUN*.tar')

# Logic tree mean scenarios
scenario_databases = list()
scenario_databases$logic_tree_mean_curve_HS = read.csv(
    '../../sources/hazard/scenarios_ID710.5/random_kermadectonga2/random_scenarios_kermadectonga2_logic_tree_mean_HS.csv')
