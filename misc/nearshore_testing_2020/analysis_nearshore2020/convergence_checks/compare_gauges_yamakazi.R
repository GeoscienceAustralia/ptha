x_h = readRDS(Sys.glob('../gauge_RDS_files/OUTPUTS/Tohoku2011*/RUN*/gauges_plot_2011-03-11_Tohoku2011_YamakaziEtAl2018_HIGHRES-risetime_0-full-linear_with_manning-0.035-highres_NSW.RDS'))
...
pdf('compare_stage_ts_Yamakazi.pdf', width=12, height=7)
par(mfrow=c(2,1))
...
#     ni                                                    
#[1,] "1" "TwofoldBay_1min_BOM"        "-0.0191915510709215"
#[2,] "2" "Sydney_FortDenison_1min_PA" "0.0189574048947332" 
#[3,] "3" "Sydney_BotanyBay_1min_PA"   "-0.116351717657874" 
#[4,] "4" "PortKembla_1min_BOM"        "0.0604646444782154" 
summary(convergence_stat[ni])
#     Min.    1st Qu.     Median       Mean    3rd Qu.       Max. 
#-0.1163517 -0.0434816 -0.0001171 -0.0140303  0.0293342  0.0604646 
...
#
png('Convergence_plot_PortKembla_Botany_yamakazi.png', width=10, height=4.5, units='in', res=300)
ADD_OBS = FALSE
par(mfrow=c(2,1))
par(mar = c(1, 6, 3, 1))
...
legend('topleft', c('High resolution', 'Default resolution'), lty=c(1,1), horiz=TRUE, 
       col=c('black', 'red'), bty='n', cex=1.3, lwd=c(1, 1))
