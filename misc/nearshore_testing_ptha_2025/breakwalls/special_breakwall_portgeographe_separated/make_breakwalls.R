...
all_shp = Sys.glob('portgeographe_entrance/*.shp')
...
local_raster = '/media/gareth/Data2/DATA/Busselton_files/20220330_Aerometrix_Lidar/DEM_merged_1m/Busselton_merged_20220330_Aerometrix_Lidar_1m_WGS84.tif'
