...
# Spatial lines @ Port Kembla -- we will interpolate off these.
all_shp = Sys.glob('portKembla/*.shp')
# NSW LADS DEM that gives good coverage of the Port Kembla breakwalls
#local_raster = '/media/gareth/Windows7_OS/Users/gareth/Documents/work/AustPTHA/DATA/ELEV/NSW/DATA_338901/NSW Government - DPIE/DEMs/5 Metre/NSW_Marine_5m_TopoBathy_DEM.tif'
local_raster = '../elevation/orig/nsw/bathytopo/DATA_338901/NSW Government - DPIE/DEMs/5 Metre/NSW_Marine_5m_TopoBathy_DEM.tif'
...
# Ulladulla
all_shp = Sys.glob('ulladulla/*.shp')
#local_raster = '/media/gareth/Windows7_OS/Users/gareth/Documents/work/AustPTHA/DATA/ELEV/NSW/DATA_338896/NSW Government - DPIE/DEMs/5 Metre/NSW_Marine_5m_TopoBathy_DEM.tif'
local_raster = '../elevation/orig/nsw/bathytopo/DATA_338896/NSW Government - DPIE/DEMs/5 Metre/NSW_Marine_5m_TopoBathy_DEM.tif'
# Points with this spacing along the line
line_spacing = 5
# Point elevation based on maxima inside this radius
buffer_size = 15
...
# Portland -- the DEM here is not so good, so we use a coarser buffer_size
all_shp = Sys.glob('portland/*.shp')
#local_raster = '/media/gareth/Windows7_OS/Users/gareth/Documents/work/AustPTHA/DATA/ELEV/Vic/Victorian-coast_Bathy_10m_EPSG4326.tif'
local_raster = '../elevation/orig/vic/vcdem2017/Victorian-coast_Bathy_10m_EPSG4326.tif'
# Points with this spacing along the line
line_spacing = 5
# Point elevation based on maxima inside this radius
buffer_size = 50 # DEM less good -- coarser buffer
make_lines_with_max_buffer(all_shp, local_raster, line_spacing, buffer_size)

# Hillarys
all_shp = Sys.glob('perth/hillar*.shp')
#local_raster = "/media/gareth/Windows7_OS/Users/gareth/Documents/work/AustPTHA/DATA/ELEV/WA/Perth_nearshore_tifs/merged_rasters/tile_3.tif"
local_raster = "../elevation/derived_for_model/wa/nearshore_tifs/tile_3.tif"
line_spacing = 5
# Point elevation based on maxima inside this radius
buffer_size = 15
make_lines_with_max_buffer(all_shp, local_raster, line_spacing, buffer_size)
...
#local_raster = "/media/gareth/Windows7_OS/Users/gareth/Documents/work/AustPTHA/DATA/ELEV/WA/Perth_nearshore_tifs/merged_rasters/tile_6.tif"
local_raster = "../elevation/derived_for_model/wa/nearshore_tifs/tile_6.tif"
line_spacing = 5
# Point elevation based on maxima inside this radius
buffer_size = 15
make_lines_with_max_buffer(all_shp, local_raster, line_spacing, buffer_size)
...
#local_raster = '/media/gareth/Windows7_OS/Users/gareth/Documents/work/AustPTHA/DATA/ELEV/WA/Perth_nearshore_tifs/merged_rasters/tile_7.tif'
local_raster = "../elevation/derived_for_model/wa/nearshore_tifs/tile_7.tif"
line_spacing = 5
# Point elevation based on maxima inside this radius
buffer_size = 15
make_lines_with_max_buffer(all_shp, local_raster, line_spacing, buffer_size)
