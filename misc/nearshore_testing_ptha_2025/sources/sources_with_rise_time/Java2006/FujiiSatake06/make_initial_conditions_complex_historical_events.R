...
source_tifs = paste0('FujiiSatake06_Java2006_', 1:nrow(source_data), '_unit_source_KAJIURA_SMOOTHED.tif')
...
write.csv(swals_forcing_data, file='FujiSatake2006_Java2006_time_varying_forcing_realistic.csv', row.names=FALSE)
...
write.csv(swals_forcing_data, file='FujiSatake2006_Java2006_time_varying_forcing_instantaneous.csv', row.names=FALSE)
