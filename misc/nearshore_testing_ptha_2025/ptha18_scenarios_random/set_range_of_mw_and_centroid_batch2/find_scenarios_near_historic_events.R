...
target_events = list(
    ...
    'sumatra2004-batch2' = list(
        ...
        # that includes some non-strike-slip components, perhaps a lower value is 
        # appropriate herein?
        Mw_lower = 9.2 - 0.15,
        Mw_upper = 9.2 + 0.15,
