...
target_events = list(
    ...
    'sumatra2005-batch5' = list(
        Mw_lower = 8.6 - 0.15,
        Mw_upper = 8.6 + 0.15,
        event_point_1 = c( 99.0, 0), # Similar to eastern Down-dip limit of Fujii et al. (2021)
        event_point_2 = c(96.1, 3.7), # Similar to western down-dip limit of Fujii et al. (2021) 
        event_time = strptime('2005-03-28 16:09:36', format='%Y-%m-%d %H:%M:%S', tz='Etc/GMT'),
