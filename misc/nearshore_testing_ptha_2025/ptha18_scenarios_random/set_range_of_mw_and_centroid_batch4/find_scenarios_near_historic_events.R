...
target_events = list(
    ...
    'southamerica2015-batch4' = list(
        Mw_lower = 8.3 - 0.15,
        Mw_upper = 8.3 + 0.15,
        event_point_1 = c(287.58 , -32.21), # Covers range of most inversions in Satake and Heidarzadeh (2017) PAGES
        event_point_2 = c(287.61 , -29.49),
        event_time = strptime('2015-09-16 22:54:32', format='%Y-%m-%d %H:%M:%S', tz='Etc/GMT'),
        tsunami_event_dir = '/g/data/fj6/PTHA/AustPTHA_1/SOURCE_ZONES/southamerica/TSUNAMI_EVENTS/'
     ),

    'southamerica2014-batch4' = list(
        Mw_lower = 8.2 - 0.15,
        Mw_upper = 8.2 + 0.15,
        event_point_1 = c( 288.96, -21.16), # Southern limit of inversion in Gusman et al (2015), http://dx.doi.org/10.1002/2014GL062604
        event_point_2 = c(288.15, -18.77), # Just beyond northern limit of inversion in Gusman et al (2015), http://dx.doi.org/10.1002/2014GL062604
        event_time = strptime('2014-04-01 23:46:47', format='%Y-%m-%d %H:%M:%S', tz='Etc/GMT'),
        tsunami_event_dir = '/g/data/fj6/PTHA/AustPTHA_1/SOURCE_ZONES/southamerica/TSUNAMI_EVENTS/'
     )
