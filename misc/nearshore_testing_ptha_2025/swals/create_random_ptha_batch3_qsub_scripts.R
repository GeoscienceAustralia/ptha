...
raster_files = Sys.glob('../ptha18_scenarios_random/set_range_of_mw_and_centroid_batch3/*/*.tif')
...
for(i in 1:number_of_qsub_files){
    output_qsub_filename = paste0('run_ptha18_batch3_random_like_historic_batch_', 100 + i, '.sh')
