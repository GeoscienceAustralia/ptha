...
```{r ptha18_tonga_point_plot1, fig.width=7, fig.height=5}
# Plot it
...
improves. 
```{r ptha18_tonga_point_plot1_moresam, fig.width=7, fig.height=5}
...
```{r ptha18_tonga_point_plot2, fig.width=7, fig.height=5}
# Plot it
plot(stage_seq, stage_exrates_ptha18, log='xy', t='o', xlim=c(0.1, 10), ylim=c(1e-04, 1e-01),
     xlab='Max-stage (m)', ylab='Exceedance rate (events/year)',
...
```{r ptha18_tonga_point_plot3, fig.width=7, fig.height=5}
# Plot it
plot(stage_seq, stage_exrates_ptha18, log='xy', t='o', xlim=c(0.1, 10), ylim=c(1e-04, 1e-01),
     xlab='Max-stage (m)', ylab='Exceedance rate (events/year)',
...
```{r compareAllApproaches, fig.width=7, fig.height=5}
# Plot it
