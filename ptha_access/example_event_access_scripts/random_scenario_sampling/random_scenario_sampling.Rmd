...
```{r ptha18_tonga_point_plot1, fig.width=7, fig.height=5, warning=FALSE}
# Plot it
...
improves. 
```{r ptha18_tonga_point_plot1_moresam, fig.width=7, fig.height=5, warning=FALSE}
...
are less than `r round(median(event_peak_stage[random_scenarios_simple$inds]), 2)`. 
```{r quantorig}
...
```{r ptha18_tonga_point_plot2, fig.width=7, fig.height=5, warning=FALSE}
# Plot it
plot(stage_seq, stage_exrates_ptha18, log='xy', t='o', xlim=c(0.1, 10), ylim=c(1e-04, 1e-01),
     xlab='Max-stage (m)', ylab='Exceedance rate (events/year)',
...
```{r ptha18_tonga_point_plot3, fig.width=7, fig.height=5, warning=FALSE}
# Plot it
plot(stage_seq, stage_exrates_ptha18, log='xy', t='o', xlim=c(0.1, 10), ylim=c(1e-04, 1e-01),
     xlab='Max-stage (m)', ylab='Exceedance rate (events/year)',
