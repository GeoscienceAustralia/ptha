...
```
This indicates that at this site, for this stage-threshold and scenario-frequency model, we would need to use approximately `r signif(variance_reduction_factor, 3)` times as many samples with stratified-sampling to get the same accuracy as stratified/importance-sampling.
