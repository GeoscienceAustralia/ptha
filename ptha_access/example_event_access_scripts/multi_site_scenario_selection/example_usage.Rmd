...
the scenarios. 
```{r scenarioCriteria3, cache=FALSE, fig.width=11, fig.height=9} 
...
```{r scenarioSubsetting, cache=FALSE, fig.width=8, fig.height=6}
...
The code above produces some figures showing the initial condition in the output directory named `r plot_outdir`. An example is below.
