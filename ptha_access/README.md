...
described below. Numerous software dependencies are required to run these codes,
[as described here](INSTALL.md)

Unfortunately the process may be challenging for users with limited experience
in scientific programming and linux. Users doing tsunami hazard studies **in
Australia** can alternatively contact Geoscience Australia directly if they
have difficulty with any of these steps (please email Gareth Davies at
