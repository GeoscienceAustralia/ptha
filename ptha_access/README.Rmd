# **Codes to access the 2018 Australian PTHA results**
...
These codes can be used to access the 2018 Australian PTHA results, developed
...
the assumptions underlying our linear tsunami model, or occur in regions where
our coarse resolution model and bathymetric data cannot properly resolve the
flow. This is increasingly likely close to the coast, both because the mean
depth reduces, and the ratio of the wave height to the water depths increases.
For modelling purposes we strongly encourage the use of points well offshore in
deep water (preferably with wave heights of interest not exceeding a few
