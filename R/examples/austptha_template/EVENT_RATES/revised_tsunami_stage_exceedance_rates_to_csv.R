...
# Hack the names into something that's easier to interpret
new_names  = gsub(model_for_shapefile, substitute_name_model_for_csv, names(output_signif))
output_signif_tmp = output_signif
names(output_signif_tmp) = new_names
write.csv(output_signif_tmp, 
    paste0(output_dir, 'revised1_tsunami_stages_at_fixed_return_periods.csv'),
    row.names=FALSE)
...
store_as_shapefile(output_signif, 'revised1_tsunami_stages_at_fixed_return_periods')
...
if(adjust_using_greens_law){
    ...
    write.csv(output_greens_law_signif, 
        paste0(output_dir, 'revised1_tsunami_stages_greens_law_to_1m_at_fixed_return_periods.csv'),
        row.names=FALSE)
    store_as_shapefile(output_greens_law_signif, 'revised1_tsunami_stages_greens_law_to_1m_at_fixed_return_periods')
}
