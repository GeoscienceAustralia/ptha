...
out_dir = 'preprocessed_source_rate_revised_stage_exrates/'
dir.create(out_dir, showWarnings=FALSE)
point_lower_index = 1 #as.numeric(commandArgs(2, trailingOnly=TRUE))
point_upper_index = 20185 #as.numeric(commandArgs(3, trailingOnly=TRUE))
MC_CORES = 16
SAMPLE_LOGIC_TREE = TRUE
NUM_LOGIC_TREE_SAMPLE = 3000
#
